...
"           var rer = new RegExp('^get_Relay|MESS_RESET|MESS_WARNING|MESS_SD|MESS_TEMP|MESS_LIFE|MESS_ERROR|[(]MAIL[)]|MAIL_AUTH|MAIL_INFO|[(]SMS[)]|UPDATE_I2C|Boiler[(]BOILER_ON|Boiler[(]SCHEDULER_ON|Boiler[(]ADDH|CIRC|RESH|Boiler[(]LEGIONELLA|et_Network[(]DHCP|et_Network[(]PASSWORD|et_oHP[(]ADD_HEA|et_oHP[(]BEEP|RTV_OFF|get_oHP[(]SAVE_ON|et_oHP[(]NEXTION|et_oHP[(]HIST|et_oHP[(]EEV_CLOSE|get_datetime[(]UPDATE|oHP[(]WSPIF');\r\n"
